...
from PySide6.QtWidgets import (QMainWindow, QWidget, QVBoxLayout, QHBoxLayout,
                            ...
                            QMessageBox, QFileDialog, QTextEdit, QApplication)
...
from src.backend.audio import AudioProcessor
...
class MainWindow(QMainWindow):
    ...
    def playCurrentSegment(self):
        try:
            ...
            current_words = self.audio_processor.process_segment(
                self.audio_helper.get_current_segment_words()
            )
